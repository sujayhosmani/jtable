...
class FinalTimeTable extends StatelessWidget {
  @override
      ...
      child: Column(
        children: [
          Padding(
            ...
            child: HeadingTitle(label: "Final Exam Time Table",color: Utils.fromHex("#F67B5A"), onTap: (){print("");},),
          ),
          Table(
